  ...
  if (get !== null) {
    ...
    tasks.forEach((item, indexNo) => {
      ...
      const editItem = (e) => {
        ...
        writeEdit.id = 'edit';
        writeEdit.value = e.target.innerHTML;
        writeEdit.addEventListener('keypress', saveEdit);
        e.target.innerHTML = '';
        e.target.parentNode.insertBefore(writeEdit, e.target.nextSibling);
      };
      ...
      description.addEventListener('click', editItem);
